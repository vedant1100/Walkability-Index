...
map.on('error', (e) => {
    if (e.source === 'walkability-data') {
        ...
        console.error('Failed to load walkability data from GitHub release asset.', e.error);
    }
});
...
map.on('load', () => {
    ...
    map.addSource('walkability-data', {
        type: 'geojson',
        data: 'https://github.com/vedant1100/Walkability-Index/releases/download/v1.0-data/CA_Walkability.geojson'
    });
